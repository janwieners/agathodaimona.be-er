                            ...
                            foreach $i(@dp){
                               ...
                               if ($pnavn =~ /\S/){
                                  ...
                                  if ($i =~ /<keywordlist>/){
                                     ...
                                     print DPAR "<FRAMESET COLS=\"20%, *\" BORDER=1>\n";
                                     print DPAR "<FRAME SRC=\"$bph\">\n";
                                     print DPAR "<FRAME SRC=\"$cph\" name=\"pc\">\n";
                                     print DPAR "<\/FRAMESET>\n";
                                     print DPAR "<\/FRAMESET>\n";
                                     ...
                                     foreach $k(@kw){
                                        ...
                                        $khref = $pnavn.$khref;
                                        $khref = $khref.".htm";
                                        print DPARB "<a href=\"$khref\" target=\"pc\">\n";
                                        print DPARB "$k<\/a><br>\n";
                                        open(SISTE,">$pdir\/$khref");
                                        print SISTE "<html><head><title>$pnavn<\/title>\n";
                                        print SISTE "<body><p>$k\n";
                                        print SISTE "<\/body><\/html>\n";
                                     }
                                     print DPARC "<html><head><title>$pnavn<\/title>\n";
                                     print DPARC "<body>\n";
                                     print DPARC "<p>Choose a keyword!\n";
                                     print DPARC "<\/body><\/html>\n";
                                  }
                                  else{
                                     print DPAR "<html><head><title>$pnavn<\/title>\n";
                                     print DPAR "<body>\n";
