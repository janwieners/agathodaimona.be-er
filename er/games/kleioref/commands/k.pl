          ...
          print PAR "<\/body><\/html>\n";
           ...
           if ($cont ne ""){ 
            ...
            foreach $c(@cont){
               ...
               print CONTLIST "<br><a href=\"$conthref\" target=\"_top\">\n";
               print CONTLIST $contnavn,"<\/a>\n";
               $contd = $contnavn."d.htm";
               $contt = $contnavn."t.htm";
               open (NEWC,">$i\/$conthref");
               print NEWC "<HEAD>\n";
                      ...
                      if ($d !~ /<identical/){
                          ...
                          foreach $i(@dp){
                              ...
                              # if ($newcat =~ /\S/){
                               ...
                               $cph = "c".$phref;
                               if ($pnavn =~ /\S/){
                                  print DIRA "<a href=\"$phref\" target=\"w3\">\n";
